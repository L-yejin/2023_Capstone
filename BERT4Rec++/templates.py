...
def augment(args):
    if args.data_type == 'origin_dataset':
        args.N_Aug = None
        args.P = None

    elif args.data_type == 'noise_dataset':
    ...
    elif args.data_type == 'similarity':
        args.N_Aug = None # [5, 10, 15]
        args.P = None # [None, 0.1, 0.2, 0.3]

    elif args.data_type == 'redundancy':
        args.N_Aug = None # [5, 10, 15]
        args.P = None # [None, 0.1, 0.2, 0.3]
...
def set_template(args):
    if args.template is None:
        ...
        args.dataset_code = 'ml-1m' # ml-1m 다른 데이터셋 추가될 경우 변경
