...
class BertDataloader(AbstractDataloader):
    ...
    def get_pytorch_dataloaders(self): #
        ...
        return train_loader, val_loader, test_loader, self.user_count, self.item_count
...
class BertTrainDataset(data_utils.Dataset):
    def __init__(self, u2seq, max_len, mask_prob, mask_token, num_items, rng):
        self.u2seq = u2seq # user와 item dict
        self.users = sorted(self.u2seq.keys()) # user
        self.max_len = max_len # 100
        self.mask_prob = mask_prob #  0.15
        self.mask_token = mask_token #3707
        self.num_items = num_items #3706
        self.rng = rng # 이게 random.Random(seed)
