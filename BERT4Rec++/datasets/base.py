...
from data_augmentation import addNoise
...
class AbstractDataset(metaclass=ABCMeta):
    ...
    def preprocess(self):
        ...
        if self.data_type == 'origin_dataset': # 데이터 증강을 하지 않은 경우
            ...
            df, umap, smap = addNoise(self.args, df, self.N_Aug, self.P)
        else: # 다른 타입꺼 추가하기
            pass
    ...
    def _get_preprocessed_folder_path(self):
        ...
        if self.args.data_type == 'noise_dataset':
            type_name = 'noise_dataset-'+ self.args.type_noise_item
        else:
            type_name = self.args.data_type
        folder_name = 'type_{}-size_{}-p{}' \
            .format(type_name, self.args.N_Aug, self.args.P)
